      ...
      <div class="main-header">
        ...
        <div class="header-nav">
          <nav class="nav-main-menu">
            <ul class="main-menu">
              <li><a class='{{ request()->routeIs('beranda') | request()->routeIs('home') ? 'active' : '' }}' href='{{ route('beranda') }}'>Beranda</a></li>
              <li><a class='{{ request()->routeIs('kerja') ? 'active' : '' }}' href='{{ route('kerja') }}'>Cari Kerja</a></li>
              @auth
              <li><a class="" href="#">Buat Lowongan</a></li>
              @endauth
              <li><a class='{{ request()->routeIs('pricing') ? 'active' : '' }}' href='{{ route('pricing') }}'>Langganan</a></li>
            </ul>
          </nav>
  ...
  <footer class="footer mt-50">
    <div class="container">
      ...
      <div class="footer-bottom mt-50">
        <div class="row">
          <div class="col-md-6"><span class="font-xs color-text-paragraph">Copyright &copy; 2024. MusicianCareer all
              right
              reserved</span></div>
