<div>
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="block-banner text-center pb-40 pt-40">
                            <h1 class="heading-banner wow animate__animated animate__fadeInUp">Ada <span
                                    class="color-brand-2">102,256 </span>Postingan<br class="d-none d-lg-block">Disini
                                untuk mu!</h1>
                            <p class="font-lg wow animate__animated animate__fadeInUp color-text-paragraph mt-20">Cari
                                kerja sebagai, Penyanyi atau Pemain alat musik.</p>
                        </div>
                    </div>
                </div>
    ...
    <section class="section-box mt-80">
        <div class="section-box wow animate__animated animate__fadeIn">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">Telusuri berdasarkan
                        kategori</h2>
                    <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Temukan pekerjaan
                        yang cocok untuk Anda. sekitar 150+ pekerjaan baru setiap hari</p>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="pl-30">
                        ...
                        <p class="font-lg color-text-paragraph-2">Work Profile is a personality assessment that
                            measures an
                            individual's work personality through their workplace traits, social and emotional traits;
                            as well as the
                ...
                <div class="mt-50">
                    <div class="tab-content" id="myTabContent-1">
                        <div class="tab-pane fade show active" id="tab-job-1" role="tabpanel"
                                    ...
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="mt-5"><span class="card-location mr-15">Chicago,
                                                    US</span><span class="card-time">6
                                                    mins ago</span></div>
                                            <div class="card-2-bottom mt-20">
                                                <div class="row">
                                                    <div class="col-xl-7 col-md-7 mb-2"><a
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        ...
                                        <div class="card-block-info">
                                            ...
                                            <div class="mt-5"><span class="card-location mr-15">Chicago,
                                                    US</span><span class="card-time">9
                                                    mins ago</span></div>
                                            <div class="card-2-bottom mt-20">
                                                <div class="row">
                                                    <div class="col-xl-7 col-md-7 mb-2"><a
                                                            ...
                                                            class='btn btn-tags-sm mr-5' href='jobs-grid.html'>JS</a>
                                                    </div>
                                                    <div class="col-xl-5 col-md-5 text-lg-end"><span
                                                            class="card-text-price">$120 -
                                                            $150</span><span class="text-muted">/Hour</span></div>
                                                </div>
                                            </div>
                                            <p class="font-sm color-text-paragraph mt-20">Lorem ipsum dolor sit amet,
                            ...
                            <div class="text-center mt-10"><a class="btn btn-brand-1 btn-icon-more hover-up">See more
                                </a></div>
                        </div>
                                            ...
                                            <div class="card-2-bottom mt-20">
                                                <div class="row">
                                                    <div class="col-xl-7 col-md-7 mb-2"><a
                                                            class='btn btn-tags-sm mr-5'
                                                            href='jobs-grid.html'>React</a><a
                                                            class='btn btn-tags-sm mr-5' href='jobs-grid.html'>NextJS
                                                        </a>
                                                    </div>
                                                    <div class="col-xl-5 col-md-5 text-lg-end"><span
                                                            class="card-text-price">$80 -
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full
                                                    time</span></span>
                                            <div class="image-box">
                                                <figure><img src="assets/imgs/page/homepage2/img5.png"
                                                        alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full
                                                    time</span></span>
                                            <div class="image-box">
                                                <figure><img src="assets/imgs/page/homepage2/img6.png"
                                                        alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full
                                                    time</span></span>
                                            <div class="image-box">
                                                <figure><img src="assets/imgs/page/homepage2/img3.png"
                                                        alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span
                                                class="lbl-hot bg-green"><span>Freelancer</span></span>
                                            <div class="image-box">
                                                <figure><img src="assets/imgs/page/homepage2/img1.png"
                                                        alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full
                                                    time</span></span>
                                            <div class="image-box">
                                                <figure><img src="assets/imgs/page/homepage2/img2.png"
                                                        alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div class="card-grid-2 grid-bd-16 hover-up">
                                        <div class="card-grid-2-image"><span class="lbl-hot"><span>Full
                                                    time</span></span>
                                            <div class="image-box">
                                                <figure><img src="assets/imgs/page/homepage2/img4.png"
                                                        alt="jobBox"></figure>
                                            </div>
                                        </div>
                                        <div class="card-block-info">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                    <h2 class="mb-40">Pencarian kerja untuk orang-orang yang tertarik menyanyi dan memainkan alat
                        musik</h2>
                    <div class="box-checkbox mb-30">
                        <h6>Daftar Akun</h6>
                        <p class="font-md color-text-paragraph-2">Pertama kalian harus <a class="font-bold"
                                href="{{ route('register') }}">Daftar</a> terlebih dahulu.</p>
                    </div>
                    <div class="box-checkbox mb-30">
                        <h6>Atur Profile Kamu</h6>
                        <p class="font-md color-text-paragraph-2">Buat profile kamu semenarik mungkin supaya menarik
                            dan juga tambahkan video kamu sedang bermain alat musik atau bernyanyi.</p>
                    </div>
                    <div class="box-checkbox mb-30">
                        <h6>Cari Kerja</h6>
                        <p class="font-md color-text-paragraph-2">Pergi kehalaman <a class="font-bold"
                                href="">Cari Kerja</a> dan daftarkan diri kamu sesuai kebutuhan lowongan.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section-box mt-70 mb-40">
        <div class="container">
            <div class="text-start">
                ...
                <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Berikut ini tahapan
                    untuk memulai mencari lowongan kerja di MusicianCareer.</p>
            </div>
            <div class="mt-70">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="box-step step-1">
                            ...
                            <p class="font-lg color-text-paragraph-2">Pertama kalian harus, <br
                                    class="d-none d-lg-block"> <a class="font-bold"
                                    href="{{ route('register') }}">Daftar</a> terlebih dahulu.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="box-step step-2">
                            ...
                            <p class="font-lg color-text-paragraph-2">Buat profile kamu semenarik mungkin supaya
                                menarik dan juga tambahkan <br class="d-none d-lg-block">video kamu sedang bermain
                                alat <br class="d-none d-lg-block">musik atau bernyanyi.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="box-step">
                            ...
                            <p class="font-lg color-text-paragraph-2">Pergi kehalaman <a class="font-bold"
                                    href="">Cari Kerja</a> dan <br class="d-none d-lg-block">daftarkan diri
                                kamu sesuai <br class="d-none d-lg-block">kebutuhan lowongan.</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                    ...
                                    <div class="card-block-info">
                                        ...
                                        <p class="mt-10 color-text-paragraph font-sm">Our mission is to create the
                                            world&amp;rsquo;s most
                                            sustainable healthcare company by creating high-quality healthcare products
                                            in iconic, sustainable
                                            packaging.</p>
                                        <div class="card-2-bottom mt-20">
                                            <div class="row">
                                    ...
                                    <div class="card-block-info">
                                        ...
                                        <div class="card-2-bottom mt-20">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 text-end col-6 pt-15"><span
                                                        class="color-text-paragraph-2 font-xs">6 mins
                                                        to read</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-block-info">
                                        ...
                                        <div class="card-2-bottom mt-20">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 text-end col-6 pt-15"><span
                                                        class="color-text-paragraph-2 font-xs">9 mins
                                                        to read</span></div>
                                            </div>
                                        </div>
                                    </div>
