          ...
          <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
              <form id="form-basic">
                ...
                <div class="box-pricing-item">
                  <h3>Basic</h3>
                  <div class="box-info-price"><span class="text-price color-brand-2">Rp. 40.000</span></div>
                  <div class="border-bottom mb-30">
                    <p class="text-desc-package font-sm color-text-paragraph mb-30">Cocok untuk usaha anda yang belum
                      memiliki cabang.</p>
                  </div>
                  <ul class="list-package-feature">
                    <li>15x Menayangkan Iklan Lowongan</li>
                  </ul>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
              <form id="form-standard">
                <div class="box-pricing-item">
                  <h3>Standard</h3>
                  <div class="box-info-price"><span class="text-price for-month display-month">Rp. 80.000</span></div>
                  <div class="border-bottom mb-30">
                    <p class="text-desc-package mb-30">Cocok untuk usaha anda yang memiliki 2 - 4 cabang.</p>
                  </div>
                  <ul class="list-package-feature">
                    <li>30x Menayangkan Iklan Lowongan</li>
                  </ul>
                  <div><button class="btn btn-border" type="submit">Pesan Sekarang</button></div>
                </div>
              </form>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
              <form id="form-enterprice">
                <div class="box-pricing-item">
                  <h3>Enterpr&imath;se</h3>
                  <div class="box-info-price"><span class="text-price for-month display-month">Rp. 150.000</span></div>
                  <div class="border-bottom mb-30">
                    <p class="text-desc-package mb-30">Cocok untuk anda yang memiliki banyak cabang.</p>
                  </div>
                  <ul class="list-package-feature">
                    <li>60x Menayangkan Iklan Lowongan</li>
                  </ul>
                  <div><button class="btn btn-border" type="submit">Pesan Sekarang</button></div>
                </div>
              </form>
