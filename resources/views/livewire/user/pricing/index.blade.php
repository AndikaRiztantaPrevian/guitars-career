                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp"
                            ...
                            <div class="box-pricing-item">
                                ...
                                <div class="border-bottom mb-30">
                                    <p class="text-desc-package font-sm color-text-paragraph mb-30">For most businesses
                                        that want to
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp"
                            ...
                            <div class="box-pricing-item">
                                ...
                                <div class="box-info-price"><span
                                        ...
                                        class="text-month">/month</span></div>
                                <div class="border-bottom mb-30">
                                    <p class="text-desc-package mb-30">For most businesses that want to otpimize web
                                        queries</p>
                                </div>
                                <ul class="list-package-feature">
                                    <li>Unlimited updates</li>
