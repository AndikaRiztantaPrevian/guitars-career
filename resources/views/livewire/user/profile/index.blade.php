    ...
    <section class="section-box-2">
        <div class="container">
            ...
            <div class="box-company-profile">
                <div class="image-compay"><img src="assets/imgs/page/candidates/candidate-profile.png" alt="jobbox">
                </div>
                <div class="row mt-10">
                    <div class="col-lg-8 col-md-12">
                        <h5 class="f-18">{{ auth()->user()->name }} <span class="card-location font-regular ml-20">New
                                York, US</span></h5>
                    ...
                    <div class="box-nav-tabs nav-tavs-profile mb-5">
                        <ul class="nav" role="tablist">
                            <li><a class="btn btn-border aboutus-icon mb-20 active" href="#tab-my-profile"
                                    ...
                                    aria-selected="true">Profile Saya</a></li>
                            <li><a class="btn btn-border recruitment-icon mb-20" href="#tab-my-jobs"
                                    data-bs-toggle="tab" role="tab" aria-controls="tab-my-jobs"
                                    aria-selected="false">Lamaran Saya</a></li>
                            <li><a class="btn btn-border people-icon mb-20" href="#tab-saved-jobs" data-bs-toggle="tab"
                                    role="tab" aria-controls="tab-saved-jobs" aria-selected="false">Lowongan Yang
                                    Disimpan</a></li>
                        </ul>
                        <div class="border-bottom pt-10 pb-10"></div>
                    ...
                    <div class="content-single">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="tab-my-profile" role="tabpanel"
                                ...
                                <h3 class="mt-0 mb-15 color-brand-1">Akun Saya</h3><a
                                    class="font-md color-text-paragraph-2" href="#">Perbarui akun anda</a>
                                <div class="mt-35 mb-40 box-info-profie">
                                    <div class="image-profile"><img
                                            src="assets/imgs/page/candidates/candidate-profile.png" alt="jobbox">
                                            ...
                                            <div class="form-contact">
                                                <div class="form-group">
                                                    <input class="form-control search-icon" type="text"
                                                        value="" placeholder="Menyanyi, Piano, Gitar..">
                                                </div>
                                            </div>
