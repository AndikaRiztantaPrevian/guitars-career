...
@section('content')
  <section class="section-box-2">
    <div class="container">
      <div class="banner-hero banner-image-single"><img src="assets/imgs/page/candidates/img.png" alt="jobbox"><a
      ...
      <div class="box-company-profile">
        ...
        <div class="row mt-10">
          <div class="col-lg-8 col-md-12">
            <h5 class="f-18">{{ auth()->user()->name }} <span class="card-location font-regular ml-20">New York, US</span></h5>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-12">
          <div class="box-nav-tabs nav-tavs-profile mb-5">
            ...
            <div class="border-bottom pt-10 pb-10"></div>
            <div class="mt-20 mb-20"><a class="link-red" href="#">Hapus Akun</a></div>
          </div>
        </div>
          ...
          <div class="content-single">
            <div class="tab-content">
              <div class="tab-pane fade show active" id="tab-my-profile" role="tabpanel" aria-labelledby="tab-my-profile">
                <h3 class="mt-0 mb-15 color-brand-1">Akun Saya</h3><a class="font-md color-text-paragraph-2"
                ...
                <div class="mt-35 mb-40 box-info-profie">
                  ...
                  </div><a class="btn btn-apply">Unggah Foto</a><a class="btn btn-link">Hapus</a>
                </div>
                <div class="row form-contact">
                  <div class="col-lg-6 col-md-12">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="font-sm color-text-mutted mb-10">Kata sandi baru</label>
                          <input class="form-control" type="password" value="123456789">
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="font-sm color-text-mutted mb-10">Ulangi kata sandi *</label>
                          <input class="form-control" type="password" value="123456789">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="box-button mt-15">
                      <button class="btn btn-apply-big font-md font-bold">Simpan semua perubahan</button>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-12">
                    <div class="box-skills">
                      ...
                      <div class="box-tags mt-30"><a class="btn btn-grey-small mr-10">Figma<span
                            class="close-icon"></span></a><a class="btn btn-grey-small mr-10">Adobe XD<span
                            class="close-icon"></span></a><a class="btn btn-grey-small mr-10">NextJS<span
                            class="close-icon"></span></a><a class="btn btn-grey-small mr-10">React<span
                            class="close-icon"></span></a><a class="btn btn-grey-small mr-10">App<span
                            class="close-icon"></span></a><a class="btn btn-grey-small mr-10">Digital<span
                            class="close-icon"></span></a><a class="btn btn-grey-small mr-10">NodeJS<span
                            class="close-icon"></span></a></div>
                      <div class="mt-40"> <span class="card-info font-sm color-text-paragraph-2">You can add up to 15
                          skills</span></div>
                    </div>
                  </div>
                </div>
