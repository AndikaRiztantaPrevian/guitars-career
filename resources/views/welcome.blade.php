...
@section('content')
    ...
    <div class="banner-hero hero-1 banner-homepage6">
      <div class="banner-inner">
        <div class="row">
          <div class="col-xl-12 col-lg-12">
            <div class="block-banner text-center pb-40 pt-40">
              <h1 class="heading-banner wow animate__animated animate__fadeInUp">Ada <span
                  class="color-brand-2">102,256 </span>Postingan<br class="d-none d-lg-block">Disini untuk mu!</h1>
              <p class="font-lg wow animate__animated animate__fadeInUp color-text-paragraph mt-20">Cari kerja sebagai, Penyanyi atau Pemain alat musik.</p>
            </div>
          </div>
        </div>
        ...
        <div class="text-center">
          <div class="list-tags-banner list-tags-banner-2 mt-20 wow animate__animated animate__fadeInUp"
  ...
  <section class="section-box mt-80">
    <div class="section-box wow animate__animated animate__fadeIn">
      <div class="container">
        <div class="text-center">
          <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">Telusuri berdasarkan kategori</h2>
          <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Temukan pekerjaan yang cocok untuk Anda. sekitar 150+ pekerjaan baru setiap hari</p>
        </div>
        ...
        <div class="col-lg-6">
          <div class="pl-30">
            ...
            <p class="font-lg color-text-paragraph-2">Work Profile is a personality assessment that measures an
              individual's work personality through their workplace traits, social and emotional traits; as well as the
              values and aspirations that drive them forward.</p>
    ...
    <div class="section-box wow animate__animated animate__fadeIn">
      <div class="container">
        <div class="text-start">
          ...
          <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Explore the different types
            of available jobs to apply<br class="d-none d-lg-block">discover which is right for you.</p>
          <div class="list-tabs list-tabs-2 mt-30">
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li><a id="nav-tab-job-2" href="#tab-job-2" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-job-2" aria-selected="false"><img src="assets/imgs/page/homepage1/marketing.svg"
                    alt="jobBox"> Marketing &amp; Sale</a></li>
              <li><a id="nav-tab-job-3" href="#tab-job-3" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-job-3" aria-selected="false"><img src="assets/imgs/page/homepage1/finance.svg"
                    alt="jobBox"> Finance</a></li>
              <li><a id="nav-tab-job-4" href="#tab-job-4" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-job-4" aria-selected="false"><img src="assets/imgs/page/homepage1/human.svg"
                    alt="jobBox"> Human Resource</a></li>
              <li><a id="nav-tab-job-5" href="#tab-job-5" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-job-5" aria-selected="false"><img src="assets/imgs/page/homepage1/retail.svg"
                    alt="jobBox"> Retail &amp; Products</a></li>
              <li><a id="nav-tab-job-6" href="#tab-job-6" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-job-6" aria-selected="false"><img src="assets/imgs/page/homepage1/content.svg"
                    alt="jobBox"> Content Writer</a></li>
              <li><a id="nav-tab-job-7" href="#tab-job-7" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-job-7" aria-selected="false"><img src="assets/imgs/page/homepage1/content.svg"
                    alt="jobBox"> Funiture Design</a></li>
              <li><a id="nav-tab-job-8" href="#tab-job-8" data-bs-toggle="tab" role="tab"
                  aria-controls="tab-job-8" aria-selected="false"><img src="assets/imgs/page/homepage1/content.svg"
                    alt="jobBox"> Other</a></li>
            </ul>
          </div>
        </div>
        <div class="mt-50">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                  <div class="card-grid-2 grid-bd-16 hover-up">
                    ...
                    <div class="card-block-info">
                      ...
                      <p class="font-sm color-text-paragraph mt-20">Lorem ipsum dolor sit amet, consectetur adipisicing
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                  <div class="card-grid-2 grid-bd-16 hover-up">
                    ...
                    <div class="card-block-info">
                      ...
                      <div class="mt-5"><span class="card-location mr-15">Chicago, US</span><span class="card-time">6
                          mins ago</span></div>
                      <div class="card-2-bottom mt-20">
                        <div class="row">
                          <div class="col-xl-7 col-md-7 mb-2"><a class='btn btn-tags-sm mr-5'
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                  <div class="card-grid-2 grid-bd-16 hover-up">
                    ...
                    <div class="card-block-info">
                      ...
                      <div class="mt-5"><span class="card-location mr-15">Chicago, US</span><span class="card-time">9
                          mins ago</span></div>
                      <div class="card-2-bottom mt-20">
                        <div class="row">
                          <div class="col-xl-7 col-md-7 mb-2"><a class='btn btn-tags-sm mr-5'
                              href='jobs-grid.html'>HTML</a><a class='btn btn-tags-sm mr-5'
                              href='jobs-grid.html'>CSS</a><a class='btn btn-tags-sm mr-5' href='jobs-grid.html'>JS</a>
                          </div>
                          <div class="col-xl-5 col-md-5 text-lg-end"><span class="card-text-price">$120 -
                              $150</span><span class="text-muted">/Hour</span></div>
                        </div>
                      </div>
                      <p class="font-sm color-text-paragraph mt-20">Lorem ipsum dolor sit amet, consectetur adipisicing
                  ...
                  <div class="card-grid-2 grid-bd-16 hover-up">
                    ...
                    <div class="card-block-info">
                      ...
                      <div class="card-2-bottom mt-20">
                        <div class="row">
                          <div class="col-xl-7 col-md-7 mb-2"><a class='btn btn-tags-sm mr-5'
                              href='jobs-grid.html'>SEO</a><a class='btn btn-tags-sm mr-5' href='jobs-grid.html'>Word
                            </a>
                          </div>
                          <div class="col-xl-5 col-md-5 text-lg-end"><span class="card-text-price">$80 -
                              $150</span><span class="text-muted">/Hour</span></div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
          <h2 class="mb-40">Pencarian kerja untuk orang-orang yang tertarik menyanyi dan memainkan alat musik</h2>
          <div class="box-checkbox mb-30">
            <h6>Daftar Akun</h6>
            <p class="font-md color-text-paragraph-2">Pertama kalian harus <a class="font-bold" href="{{ route('register') }}">Daftar</a> terlebih dahulu.</p>
          </div>
          <div class="box-checkbox mb-30">
            <h6>Atur Profile Kamu</h6>
            <p class="font-md color-text-paragraph-2">Buat profile kamu semenarik mungkin supaya menarik dan juga tambahkan video kamu sedang bermain alat musik atau bernyanyi.</p>
          </div>
          <div class="box-checkbox mb-30">
            <h6>Cari Kerja</h6>
            <p class="font-md color-text-paragraph-2">Pergi kehalaman <a class="font-bold" href="">Cari Kerja</a> dan daftarkan diri kamu sesuai kebutuhan lowongan.</p>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="swiper-slide hover-up">
                <div class="card-review-1">
                  ...
                  <div class="review-info">
                    ...
                    <div class="review-rating"> <img src="assets/imgs/template/icons/star.svg" alt="jobBox"> <img
                        src="assets/imgs/template/icons/star.svg" alt="jobBox"> <img
                        src="assets/imgs/template/icons/star.svg" alt="jobBox"> <img
                        src="assets/imgs/template/icons/star.svg" alt="jobBox"> <img
                        src="assets/imgs/template/icons/star.svg" alt="jobBox"></div>
  ...
  <section class="section-box mt-70 mb-40">
    <div class="container">
      <div class="text-start">
        <h2 class="section-title mb-10 wow animate__animated animate__fadeInUp">Tahapan Awal</h2>
        <p class="font-lg color-text-paragraph-2 wow animate__animated animate__fadeInUp">Berikut ini tahapan untuk memulai mencari lowongan kerja di MusicianCareer.</p>
      </div>
      <div class="mt-70">
        <div class="row">
          <div class="col-lg-4">
            <div class="box-step step-1">
              ...
              <h4 class="mb-20">Daftar Akun</h4>
              <p class="font-lg color-text-paragraph-2">Pertama kalian harus, <br class="d-none d-lg-block"> <a class="font-bold" href="{{ route('register') }}">Daftar</a> terlebih dahulu.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="box-step step-2">
              <h1 class="number-element">2</h1>
              <h4 class="mb-20">Atur Profile Kamu</h4>
              <p class="font-lg color-text-paragraph-2">Buat profile kamu semenarik mungkin supaya menarik dan juga tambahkan <br class="d-none d-lg-block">video kamu sedang bermain alat <br class="d-none d-lg-block">musik atau bernyanyi.</p>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="box-step">
              <h1 class="number-element">3</h1>
              <h4 class="mb-20">Cari Lowongan Kerja</h4>
              <p class="font-lg color-text-paragraph-2">Pergi kehalaman <a class="font-bold" href="">Cari Kerja</a> dan <br class="d-none d-lg-block">daftarkan diri kamu sesuai <br class="d-none d-lg-block">kebutuhan lowongan.</p>
            </div>
          </div>
        </div>
      </div>
